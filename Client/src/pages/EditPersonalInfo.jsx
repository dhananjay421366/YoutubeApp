...
export default function EditPersonalInfo() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    axios
      .patch("https://youtubeapp-ug12.onrender.com/api/v1/users/update-account", {
        fullname,
        username,
        email,
      })
          ...
          <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
            ...
            <div className="px-4 pb-4">
              <div className="flex flex-wrap gap-4 pb-4 pt-6">
                ...
                <Link to={"/channel-subscriber-page"}>  <div className="inline-block">
                  <button className="group/btn mr-1 flex w-full items-center gap-x-2 bg-[#ae7aff] px-3 py-2 text-center font-bold text-black shadow-[5px_5px_0px_0px_#4f4e4e] transition-all duration-150 ease-in-out active:translate-x-[5px] active:translate-y-[5px] active:shadow-[0px_0px_0px_0px_#4f4e4e] sm:w-auto">
                    View channel
                  </button>
                </div> </Link>
              </div>
              <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px] justify-around">
                <li>
