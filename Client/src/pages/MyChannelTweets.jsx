...
export default function MyChannelTweets() {

  const navigate = useNavigate();
  const [content, setContent] = useState("");

  // const Editetweet = async (e) => {
  //   e.preventDefault();
  //   axios
  //     .patch("/api/v1/tweets/", {
  //       content,
            ...
            <div className="px-4 pb-4">
              ...
              <div className="mt-2 border pb-2">
                ...
                <div className="flex items-center justify-end gap-x-3 px-3">
                  ...
                  <button onClick={handleSubmit} className="bg-[#ae7aff] px-3 py-2 font-semibold text-black">Send</button>
                </div>
              </div>
              <div className="py-4">
